                ...
                <div className="modal-content">
                    <div className="modal-body">
                        ...
                        <Container style={{ width: '525px', margin: '50px', color: '#4D515A', fontFamily: 'Arial' }}>
                            {/* Title */}
                            {/* <h2 style={{ fontFamily: 'Times New Roman', fontSize: '45px', marginBottom: '15px' }}>Duplicate or Delete Event</h2> */}
                            <h2 style={{ fontFamily: 'Times New Roman', fontSize: '45px', marginBottom: '15px' }}>Duplicate Event</h2>
                            {/* Divider */}
