...
const RSVPPopup = ({ onClose, eventId, userId }) => {
    ...
    useEffect(() => {
        axios.get(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/rsvp/view-status/${userId}/${eventId}`)
          .then(data => {
    ...
    const handleRSVP = async () => {
        ...
        if (rsvpStatus.data.event === undefined) {
            ...
            try {
                const response = axios.post(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/rsvp/create/${eventId}`, createData);
            ...
            try {
                const response = axios.put(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/rsvp/update/${rsvpStatus.data._id}`, updateData);
    ...
    const handleRSVPP = async () => {
        ...
        if (rsvpStatus.data.event === undefined){
            ...
            axios.post(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/rsvp/create/${eventId}`, createData)
            .then(response => {
        ...
        // Update RSVP case
            ...
            axios.put(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/rsvp/update/${rsvpStatus.data._id}`, updateData)
            .then(response => {
              // Handle success, if needed
