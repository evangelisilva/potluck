...
const DishSignupPopup = ({ onClose, userId, eventId, onSignup }) => {
    ...
    const handleRecommendationsClick = () => {
        ...
        const recommendationData = {
          ...
          axios.post(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/dishSignups/recommendDishes/${userId}`, recommendationData)
          .then(response => {
    ...
    const handleAddItem = async () => {
            ...
            try {
                const response = await axios.post(`http://ec2-3-134-116-74.us-east-2.compute.amazonaws.com:8000/api/items/${eventId}`, dishData);
