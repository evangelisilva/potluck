...
const RecapTab = ({userId, eventId, eventCallback}) => {
  ...
  useEffect(() => {
      ...
      axios.get(`http://ec2-18-222-195-53.us-east-2.compute.amazonaws.com:8000/api/eventRecap/${userId}/${eventId}`)
        .then(data => {
  ...
  const handleFileSubmit = (e) => {
      ...
      if (fileCaption === ''){
        setSubmissionValidation("Invalid submission. your submission must include both a caption and a media file");
          ...
          axios.post(`http://ec2-18-222-195-53.us-east-2.compute.amazonaws.com:8000/api/eventRecap`, fileData
          , {
          headers: {
  ...
  const handleDelete = () => {
    const response = axios.delete(`http://ec2-18-222-195-53.us-east-2.compute.amazonaws.com:8000/api/eventRecap/${metadataToDelete}`)
            ...
            <Card.Body style={{ width: '100%', height: '100%' }}>
              <Container>
                ...
                <Col>
                  ...
                  await axios.delete(`http://ec2-18-222-195-53.us-east-2.compute.amazonaws.com:8000/api/eventRecap/${Recap._id}`);
             ...
             <Row style={{marginTop: '10px'}}>
              ...
              <Button
                ...
                onClick={() => {
                    ...
                    axios.post(`http://ec2-18-222-195-53.us-east-2.compute.amazonaws.com:8000/api/eventRecap/createComment/${Recap._id}`, {userId : userId, commentString : userComment})
                     .then(response => {
                         // Handle success, if needed
