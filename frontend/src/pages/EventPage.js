...
function MyComponent({tab}) {
    ...
    const fetchSignupsByEventId = async () => {
        try {
            const signupByEventResponse = await axios.get(`http://ec2-3-133-58-38.us-east-2.compute.amazonaws.com:8000/api/dishSignups?event=${eventId}`);
    ...
    const fetchEventDetails = async () => {
        try {
            ...
            const response = await axios.get(`http://ec2-3-133-58-38.us-east-2.compute.amazonaws.com:8000/api/events/${eventId}`);
            ...
            const eventGuestsResponse = await axios.get(`http://ec2-3-133-58-38.us-east-2.compute.amazonaws.com:8000/api/events/chat/${eventId}`);
    ...
    const handleCancelInvite = async (eventId) => {
        try {
            await axios.put(`http://ec2-3-133-58-38.us-east-2.compute.amazonaws.com:8000/api/events/${eventId}`, { status: 'Canceled' });
    ...
    const handleInviteSuccess = async (emailArray) => {
        try {
            ...
            await axios.put(`http://ec2-3-133-58-38.us-east-2.compute.amazonaws.com:8000/api/events/${eventId}`, {
    ...
    const handleEditEvent = async (formData) => {
        ...
        try {
            await axios.put(`http://ec2-3-133-58-38.us-east-2.compute.amazonaws.com:8000/api/events/${eventId}`, editedEventData);
