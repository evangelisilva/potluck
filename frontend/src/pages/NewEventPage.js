...
function NewEvent() {
    ...
    const createEvent = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://ec2-3-137-149-41.us-east-2.compute.amazonaws.com:8000/api/events', eventData);
            ...
            axios.post(`http://ec2-3-137-149-41.us-east-2.compute.amazonaws.com:8000/api/rsvp/create/${response.data._id}`, createData);

            if (items) {
                for (const item of items){
                    const itemResponse = await axios.post(`http://ec2-3-137-149-41.us-east-2.compute.amazonaws.com:8000/api/items/${response.data._id}`, item);
