...
import { editEvent, getEvents, userDietRestrictions} from "../../network.ts";
import { MdEditCalendar, MdOutlineCancel } from "react-icons/md";
import { Link, useNavigate } from 'react-router-dom';
import 'react-toastify/dist/ReactToastify.css';
import "../../CSS/HomeHero.css";
import Modal from '../EventModal.tsx';
import UserEventWizard from "./UserEventWizard.tsx";
...
const UserEventView = () => {
  ...
  const [userAllergans, setUserAllergans] = React.useState<string>("");
